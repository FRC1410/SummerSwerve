...
public class Camera implements TickedSubsystem {
	...
	public double getTargetYaw(int targetIndex) {
		...
		PhotonTrackedTarget getTarget = targets.get(targetIndex);
	...
	public double getDistance() {
		...
		double distanceFromTarget = (RIGHT_ANGLE_TO_RAD - getTargetYaw(0)) * (hypotnuseOne / Math.sin(RIGHT_ANGLE_TO_RAD));
	...
	public void periodic() {
		...
		aprilYawPub.set(getTargetYaw(0));
