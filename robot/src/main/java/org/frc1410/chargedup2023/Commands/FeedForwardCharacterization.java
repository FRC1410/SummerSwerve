...
import org.frc1410.chargedup2023.util.PolynomialRegression;

public class FeedForwardCharacterization extends Command {
  private static final double startDelaySecs = 2.0;
  private static final double rampRateVoltsPerSec = 0.75;
  ...
  public boolean isFinished() {
    return this.timer.get() > 8 / FeedForwardCharacterization.rampRateVoltsPerSec + FeedForwardCharacterization.startDelaySecs;
  }
